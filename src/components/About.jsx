...
const About = () => {
  return (
    <section className="relative p-2 flex justify-between">
      <div className=" absolute z-1 rotate-270 -left-20 top-[30%] flex items-center justify-center py-10">
            <span className="w-24 h-[2px] bg-[#1a1443]"></span>
            <span className="bg-[#1a1443] w-fit p-2 px-5 text-2xl rounded-md drop-shadow-[0_0_20px_#1e1463]">ABOUT ME</span>
            <span className="w-24 h-[2px] bg-[#1a1443]"></span>
        </div>
      <div className="w-1/2 p-3 flex items-start justify-center">
      <Tilt perspective={500}  className="transform-3d ">

        <div className="w-50 h-62.5 ml-20 border-2 border-blue-500 hover:border-pink-500 overflow-hidden translate-z-14 rounded-2xl shadow-[0_0_10px_0px_gray] duration-500">
          <img
            src={MyPhoto}
