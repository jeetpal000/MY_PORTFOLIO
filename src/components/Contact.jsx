...
const Contact = () => {
  ...
  return (
    <div className="max-w-360 px-4 mx-auto flex justify-between items-center">
      <div class="lg:w-3/4 ">
        <div class="flex flex-col gap-5 lg:gap-9">
          <p class="text-sm md:text-xl flex items-center gap-3">
            <span className="bg-[#8b98a5] text-gray-800 cursor-pointer hover:scale-110 duration-100 p-3 rounded-full text-xl">
              <IoAtOutline />
            </span>
        ...
        <div class="mt-8 lg:mt-16 flex items-center gap-5 lg:gap-10">
          <a
            className="bg-[#8b98a5] p-4 rounded-full text-gray-800 text-2xl hover:bg-[#16F2B3] duration-100 hover:scale-105"
            target="_blank"
