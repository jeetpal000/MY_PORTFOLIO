...
const Education = () => {
  return (
    <>
      <div data-aos="slide-right" className="flex items-center justify-center py-5 max-sm:py-2 max-sm:absolute max-sm:mt-30 max-sm:left-1/2 transform -translate-x-1/2 ">
